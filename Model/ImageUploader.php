...
class ImageUploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH = 'tmp/solutionpioneers/bannerslider';

    /**
     * @var string
     */
    const IMAGE_PATH = 'solutionpioneers/bannerslider';

    /**
     * @var string
     */
    const FILE_TMP_PATH = 'tmp/solutionpioneers/bannerslider/images/file';

    /**
     * @var string
     */
    const FILE_PATH = 'solutionpioneers/bannerslider/images/file';
